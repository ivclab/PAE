...
--data_dir '/home/ivclab/fevemania/datasets/vggface2_mtcnn_182' \
--image_size 160 \
...
--change_weight_name_from_github official_checkpoint/20180402-114759/model-20180402-114759.ckpt-275 \
--task_name $TASK_NAME \
--task_id $TASK_ID \
--open_ratio 1.0 \
